...
To measure whether a question is about (1) economic or (2) health and welfare issues, I used a simple dictionary approach. Whilst limited compared to machine learning classification approaches, dictionary string matching was more feasible for this project. I used pre-defined policy topic dictionaries from [Lexicoder](https://www.snsoroka.com/data-lexicoder) (Albugh, et al., 2013). I wrote out the results of my measurement to the table `question_topics`. 
...
```{r plot-map, eval = TRUE, fig.width = 25, fig.height = 40, fig.cap= "Map showing the geographic distribution of question slant. A slant score of -1 indicates all questions were about health and welfare issues, a score of 1 indicates all questions were about economic issues. Constituencies shown as grey are where the MP asked no oral or written questions in 2023."}
