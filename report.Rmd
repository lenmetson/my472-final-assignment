...
```{r seat-marginality, eval = TRUE, fig.cap = "A slant score of -1 indicates all questions were about health and welfare issues, a score of 1 indicates all questions were about economic issues. Seat marginality as the average majority that an MP’s party won in the previous four elections in the constituency the MP currently represents. Higher values for marginality indicate safer seats."}
