...
The purpose of parliamentary questions are for MPs to represent their constituents’ interests. Therefore, I focus on asking what demographic factors about the constituency an MP represents drives their focus on economic or health and welfare topics. 

# Data

I drew on data from two sources: the UK Parliament API (“API”), and the [UK House of Commons constituency dashboard](https://commonslibrary.parliament.uk/constituency-dashboard/) (“dashboard”). I limit my analysis to questions asked in 2023. 

First, I pulled the text of questions from the API oral and written question endpoints. The API only returns oral questions asked in the House of Commons (HoC). However, it returns written questions from both the House of Lords (HoL) and the HoC. Therefore, when requesting the written question endpoint, I added a parameter to filter questions from the HoC. I merged oral and written questions into one table: `questions`. 
...
Overall, controlling for an MP’s party and marginality, the urbaneness of an MP's seat does not appear to predict question slant. This suggests that other factors about an MP’s seat, or factors related to the MP themselves – such as their party -  may be better discriminators of question topic.
