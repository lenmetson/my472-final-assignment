...
A crow's foot diagram of the final local relational database is shown below: 

![Crow's foot diagram of local relational database](images/my472-crow-foot.svg)
...
Exploring this, I correlate population density with slant. Figure 4 shows population density is correlated with having a stronger focus on health & welfare compared to economic issues. However, urban places might be represented by Labour MPs or could be more electorally competitive. Therefore, I add controls for party and seat marginality (defined as the mean majority an MP’s party won in the previous four elections). Adding these controls eliminates the correlation.  

```{r pop-density, eval = TRUE, fig.cap = "A slant score of -1 indicates all questions were about helath and welfare issues, a score of 1 indicates all questions were about economic issues."}
...
Finally, the relationship between health & welfare questions and population could be driven by a higher density of welfare recipients living in urban areas. Figure 5, however, there is no overall relationship – whether controls are added or not - between the number of households receiving universal claimants and focus on health and welfare issues. 

```{r con-uc-claimants, eval = TRUE, fig.cap = "A slant score of -1 indicates all questions were about helath and welfare issues, a score of 1 indicates all questions were about economic issues."}
