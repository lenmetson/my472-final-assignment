...
question_text <- dbGetQuery(
  ...
  WHERE oral_questions.question_tabled_when >= '2023-01-01T00:00:00'
...
```{r}
# Need to work out how to add in data valid 
analysis_df <- dbGetQuery(
  db, 
  "
  SELECT 
    oral_questions.question_short_text,
    oral_questions.question_tabled_when,

    members.member_name_display,
    members.member_latest_party,
    members.member_gender,
    
    constituencies.cons_name,
    ...
    constituencies.last_election_1_winning_party,
    constituencies.last_election_1_election_ID,      
    constituencies.last_election_1_electionDate, 
    ...
    constituencies.last_election_2_winning_party,
    constituencies.last_election_2_election_ID,      
    constituencies.last_election_2_electionDate, 
    constituencies.last_election_2_isGeneralElection,
    ...
    constituencies.last_election_3_winning_party,
    constituencies.last_election_3_election_ID,      
    constituencies.last_election_3_electionDate, 
    constituencies.last_election_3_isGeneralElection,
    ...
    constituencies.last_election_4_winning_party,
    constituencies.last_election_4_election_ID,      
    constituencies.last_election_4_electionDate, 
    constituencies.last_election_4_isGeneralElection,                
...
last_election_1_electorate   
constituencies.last_election_1_turnout          
last_election_1_majority     
constituencies.last_election_1_result           
last_election_1_winning_party
constituencies.last_election_1_election_ID      
last_election_1_electionDate 
constituencies.last_election_1_isGeneralElection
last_election_2_electorate   
constituencies.last_election_2_turnout          
last_election_2_majority     
constituencies.last_election_2_result           
last_election_2_winning_party
constituencies.last_election_2_election_ID      
last_election_2_electionDate 
constituencies.last_election_2_isGeneralElection
last_election_3_electorate   
constituencies.last_election_3_turnout          
last_election_3_majority     
constituencies.last_election_3_result           
last_election_3_winning_party
constituencies.last_election_3_election_ID      
last_election_3_electionDate 
constituencies.last_election_3_isGeneralElection
last_election_4_electorate   
constituencies.last_election_4_turnout          
last_election_4_majority     
constituencies.last_election_4_result           
last_election_4_winning_party
constituencies.last_election_4_election_ID      
last_election_4_electionDate 
constituencies.last_election_4_isGeneralElection
shapefile                    
constituencies.region_nation_hoclib23           
population_hoclib23          
...
age_0_29_hoclib23            
constituencies.age_30_64_hoclib23               
age_65_plus_hoclib23         
constituencies.uc_claimants_hoclib23            
median_house_price_hoclib23 
