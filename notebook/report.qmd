...
# TODO check whether I want to keep any other data

# CANDO add positions here? 
...
# TODO add reference to source script, and check they are the same 
# TODO re-run 
MPs <- dbGetQuery(db,
  "
  SELECT * 
...
answering_bodies$is_econ <- 0 
answering_bodies$is_health_welf <- 0
...
dbWriteTable(db, "answering_bodies", answering_bodies)
...
analysis_df_econ <- dbGetQuery(
  ...
  SELECT 
    ...
    members.latest_party AS asking_MP_party,
