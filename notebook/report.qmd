...
TODO decide whether to restrict analysis to england and wales, if so add filter to queries
TODO remove party plots 
TODO remove party restrictions if remove party plots 
...
# TODO remove party restriction, add national restriction 
...
geog_data <- dbGetQuery(db,
  ...
  SELECT 
    ...
    constituencies.region_nation_hoclib23 AS region,
